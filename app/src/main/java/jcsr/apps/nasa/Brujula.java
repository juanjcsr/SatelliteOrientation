...
public class Brujula extends Activity implements SensorEventListener{
    ...
    /**
     * Con el telefono en posición vertical:
     * Ejes --
     *  Y = el eje que va desde la parte inferior hasta la parte superior del teléfono
     *  X = el eje que divide al teléfono de forma horizontal
     *  Z = el eje que atravieza transversalmente el teléfono
     * Azimuth = se refiere al movimiento sobre el eje Z con respecto al norte geográfico
     * Roll = Movimiento sobre el eje Y
     * Pitch = Movimiento sobre el eje X
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCompass = (Compass) findViewById(R.id.mcompass);
